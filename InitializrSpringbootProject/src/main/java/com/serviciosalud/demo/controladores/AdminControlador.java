...
public class AdminControlador {
    ...
    public String registroProfesional(@RequestParam String nombre, @RequestParam String apellido,
            ...
            @RequestParam Double precio, @RequestParam Double calificacion, @RequestParam String localidad, @RequestParam String obraSocial,
        ...
        System.out.println("registro-prof"+ email);
        
        try {
            profesionalServicio.registrar(nombre, apellido, dni, email, telefono, sexo, password, password2,
                    matricula, precio, calificacion, localidad, obraSocial, telefonoLaboral, descripcion,
